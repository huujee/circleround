...
const TCHAR ProductNames::PRODUCT_NAME[] = _T("CircleRound");
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("CircleRound Server");
...
const TCHAR ServiceNames::TVNCONTROL_START_REGISTRY_ENTRY_NAME[] =
  _T("tvncontrol");
const TCHAR ServiceNames::SERVICE_NAME[] = _T("CircleRound");
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("CircleRound Server");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("CircleRound Server");
